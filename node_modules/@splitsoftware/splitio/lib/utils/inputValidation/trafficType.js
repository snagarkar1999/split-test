...
function logTTExistanceWarning(method, ttName) {
  ...
  log.warn((0, _concat.default)(_context = "".concat(method, ": Traffic Type ")).call(_context, ttName, " does not have any corresponding Splits in this environment, make sure you're tracking your events to a valid traffic type defined in the Split console."));
}
/**
