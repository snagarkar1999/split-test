...
var log = (0, _logger.default)(''); // include BOM and nbsp
...
function validateSplit(maybeSplit, method) {
  if (maybeSplit == undefined) {
    ...
    if (TRIMMABLE_SPACES_REGEX.test(maybeSplit)) {
      ...
      log.warn((0, _concat.default)(_context = "".concat(method, ": split name \"")).call(_context, maybeSplit, "\" has extra whitespace, trimming."));
      maybeSplit = (0, _trim.default)(maybeSplit).call(maybeSplit);
    }
...
function validateSplitExistance(context, splitName, labelOrSplitObj, method) {
  if (context.get(context.constants.READY, true)) {
    ...
    if (labelOrSplitObj === _labels.SPLIT_NOT_FOUND || labelOrSplitObj == null) {
      ...
      log.warn((0, _concat.default)(_context2 = "".concat(method, ": you passed \"")).call(_context2, splitName, "\" that does not exist in this environment, please double check what Splits exist in the web console."));
      return false;
    }
  }
