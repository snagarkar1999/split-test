...
function validateEventProperties(maybeProperties, method) {
  ...
  var keys = (0, _keys.default)(maybeProperties);
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    var isFiniteVal = (0, _lang.isFinite)(val);
    ...
    if (!(isStringVal || isFiniteVal || isBoolVal || isNullVal)) {
      ...
      val = null;
      isNullVal = true;
      log.warn((0, _concat.default)(_context = "".concat(method, ": Property ")).call(_context, keys[i], " is of invalid type. Setting value to null."));
    }
