    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            prom = new _promise.default(function () {});
          ...
          case 13:
            ...
            assert.ok((0, _now.default)() - ts < baseTimeoutInMs + 20, 'The timeout should have rejected the promise.');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            prom = new _promise.default(function (res) {
              promiseResolver = res;
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            prom = new _promise.default(function (res, rej) {
              promiseRejecter = rej;
            });
            wrapperProm = (0, _timeout.default)(baseTimeoutInMs * 100, prom);
            assert.notEqual(wrapperProm, prom, 'If we actually set a timeout it should return a wrapping promise.');
