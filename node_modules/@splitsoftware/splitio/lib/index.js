...
var _context3 = _interopRequireDefault(require("./utils/context"));
...
var buildInstanceId = function buildInstanceId(key, trafficType) {
  ...
  return (0, _concat.default)(_context = (0, _concat.default)(_context2 = "".concat(key.matchingKey ? key.matchingKey : key, "-")).call(_context2, key.bucketingKey ? key.bucketingKey : key, "-")).call(_context, trafficType !== undefined ? trafficType : '');
};
...
function SplitFactory(config) {
  ...
  var context = new _context3.default(); // Put settings config within context
  ...
  (0, _inputValidation.validateApiKey)(settings.core.authorizationKey); // Put storage config within context

  var storage = (0, _storage.default)(context);
  var gateFactory = (0, _readiness2.default)();
  context.put(context.constants.STORAGE, storage); // Put integrationsManager within context.
  ...
  var splitFactory = settings.mode === _constants.LOCALHOST_MODE ? _offline.default : _online.default; // Put readiness config within context
  ...
  return {
    ...
    client: function client(key, trafficType) {
      ...
      if (!clientInstances[instanceId]) {
        ...
        var sharedContext = new _context3.default();
        ...
        sharedContext.put(sharedContext.constants.STATUS_MANAGER, (0, _statusManager.default)(sharedContext, true));
