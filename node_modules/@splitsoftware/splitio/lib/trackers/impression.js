...
var log = (0, _logger.default)('splitio-client:impression-tracker');
...
function ImpressionTracker(context) {
  ...
  return {
    track: function track(impression, attributes) {
      ...
      if ((0, _thenable.default)(res)) res.catch(function (err) {
      ...
      if (listener || integrationsManager) {
        var impressionData = {
          ...
          impression: _objectSpread({}, impression),
...
var _default = ImpressionTracker;
