...
var _impression = _interopRequireDefault(require("../impression"));
...
(0, _tapeCatch.default)('Impression Tracker', function (t) {
  t.test('Tracker API', function (assert) {
    assert.equal((0, _typeof2.default)(_impression.default), 'function', 'The module should return a function which acts as a factory.');
    ...
    var instance = (0, _impression.default)(contextMock);
  ...
  t.test('Propagate the value as a collection into the collector', function (assert) {
    ...
    var contextMock = new ContextMock(fakeStorage, fakeSettings);
    var tracker = (0, _impression.default)(contextMock);
    tracker.track(10);
