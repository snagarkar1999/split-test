...
(0, _tape.default)('Readiness Callbacks handler - Event emitter and returned handler', function (t) {
  ...
  t.test('Providing the gate object to get the SDK status interface that manages events', function (assert) {
    ...
    (0, _forEach.default)(_context = (0, _keys.default)(gateMock)).call(_context, function (propName) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              assert.true(readyForShared instanceof _promise.default, 'It should return a promise.');
              _context2.next = 5;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              assert.true(ready instanceof _promise.default, 'It should return a promise.'); // Get the callback
