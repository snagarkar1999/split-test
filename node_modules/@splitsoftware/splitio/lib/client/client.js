...
function ClientFactory(context) {
  ...
  function getTreatments(key, splitNames, attributes) {
    ...
    var wrapUp = function wrapUp(evaluationResults) {
      ...
      (0, _forEach.default)(_context = (0, _keys.default)(evaluationResults)).call(_context, function (splitName) {
  ...
  function processEvaluation(evaluation, splitName, key, attributes) {
    ...
    log.info((0, _concat.default)(_context2 = (0, _concat.default)(_context3 = (0, _concat.default)(_context4 = "Split: ".concat(splitName, ". Key: ")).call(_context4, matchingKey, ". Evaluation: ")).call(_context3, treatment, ". Label: ")).call(_context2, label));
