...
var KeyBuilder = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(KeyBuilder, [{
    ...
    value: function buildSplitKey(splitName) {
      ...
      return (0, _concat.default)(_context = "".concat(this.settings.storage.prefix, ".split.")).call(_context, splitName);
    }
  }, {
    ...
    value: function buildTrafficTypeKey(trafficType) {
      ...
      return (0, _concat.default)(_context2 = "".concat(this.settings.storage.prefix, ".trafficType.")).call(_context2, trafficType);
    }
  }, {
    ...
    value: function isSplitKey(key) {
      return (0, _startsWithInstanceProperty(_lang))(key, "".concat(this.settings.storage.prefix, ".split."));
    }
  }, {
    ...
    value: function buildSegmentNameKey(segmentName) {
      ...
      return (0, _concat.default)(_context3 = "".concat(this.settings.storage.prefix, ".segment.")).call(_context3, segmentName);
    }
  }, {
    ...
    value: function buildSegmentTillKey(segmentName) {
      ...
      return (0, _concat.default)(_context4 = "".concat(this.settings.storage.prefix, ".segment.")).call(_context4, segmentName, ".till");
    }
  }, {
    ...
    value: function buildVersionablePrefix() {
      ...
      return (0, _concat.default)(_context5 = (0, _concat.default)(_context6 = "".concat(this.settings.storage.prefix, "/")).call(_context6, this.settings.version, "/")).call(_context5, this.settings.runtime.ip);
    }
  }, {
    ...
    value: function buildLatencyKey(metricName, bucketNumber) {
      ...
      return (0, _concat.default)(_context7 = (0, _concat.default)(_context8 = "".concat(this.buildLatencyKeyPrefix(), ".")).call(_context8, metricName, ".bucket.")).call(_context7, bucketNumber);
    }
  }, {
    key: "buildCountKey",
    value: function buildCountKey(metricName) {
      ...
      return (0, _concat.default)(_context9 = "".concat(this.buildVersionablePrefix(), "/count.")).call(_context9, metricName);
    }
  }, {
    key: "buildGaugeKey",
    value: function buildGaugeKey(metricName) {
      ...
      return (0, _concat.default)(_context10 = "".concat(this.buildVersionablePrefix(), "/gauge.")).call(_context10, metricName);
    }
  }, {
