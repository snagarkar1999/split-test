  ...
  (0, _createClass2.default)(SegmentCacheInMemory, [{
    ...
    value: function resetSegments(segmentNames) {
      ...
      if (this.segmentCache.size !== segmentNames.length) {
        ...
        try {
          for (var _iterator = (0, _getIterator2.default)(segmentNames), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            s = _step.value;
            this.addToSegment(s);
          }
        } catch (err) {
        ...
        if (index < segmentNames.length) {
          ...
          try {
            for (var _iterator2 = (0, _getIterator2.default)(segmentNames), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              s = _step2.value;
              this.addToSegment(s);
            }
          } catch (err) {
