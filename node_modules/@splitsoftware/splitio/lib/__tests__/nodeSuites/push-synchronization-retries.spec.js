...
var MILLIS_SECOND_RETRY_FOR_SEGMENT_UPDATE_EVENT = 800;
var MILLIS_SPLIT_KILL_EVENT = 900;
var MILLIS_THIRD_RETRY_FOR_SPLIT_KILL_EVENT = 1600;
/**
 * Sequence of calls:
...
function testSynchronizationRetries(fetchMock, assert) {
  ...
  (0, _eventSourceMock.setMockListener)(function (eventSourceInstance) {
    ...
    (0, _setTimeout2.default)(function () {
      ...
      client.once(client.Event.SDK_UPDATE, function () {
        ...
        assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_RETRY_FOR_FIRST_SPLIT_UPDATE_EVENT), 'SDK_UPDATE due to SPLIT_UPDATE event');
    ...
    (0, _setTimeout2.default)(function () {
      ...
      client.once(client.Event.SDK_UPDATE, function () {
        var lapse = (0, _now.default)() - start;
        assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_SECOND_RETRY_FOR_SEGMENT_UPDATE_EVENT), 'SDK_UPDATE due to SEGMENT_UPDATE event');
  ...
  fetchMock.getOnce(settings.url('/splitChanges?since=1457552620999'), function () {
    var lapse = (0, _now.default)() - start;
    assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_RETRY_FOR_FIRST_SPLIT_UPDATE_EVENT), 'fetch retry due to SPLIT_UPDATE event');
    return {
      status: 200,
  ...
  fetchMock.getOnce(settings.url('/segmentChanges/splitters?since=1457552620999'), function () {
    var lapse = (0, _now.default)() - start;
    assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_SEGMENT_UPDATE_EVENT), 'sync due to SEGMENT_UPDATE event');
    return {
      status: 200,
      body: {
        since: 1457552620999,
  ...
  fetchMock.getOnce(settings.url('/segmentChanges/splitters?since=1457552620999'), function () {
    var lapse = (0, _now.default)() - start;
    assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_SECOND_RETRY_FOR_SEGMENT_UPDATE_EVENT), 'sync second retry for SEGMENT_UPDATE event');
    return {
      status: 200,
      body: {
        since: 1457552620999,
  ...
  fetchMock.getOnce(settings.url('/splitChanges?since=1457552649999'), function () {
    ...
    var lapse = (0, _now.default)() - start;
    assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_SPLIT_KILL_EVENT), 'sync due to SPLIT_KILL event');
    return {
      status: 200,
      body: {
        since: 1457552649999,
  ...
  fetchMock.getOnce(settings.url('/splitChanges?since=1457552649999'), function () {
    var lapse = (0, _now.default)() - start;
    assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_THIRD_RETRY_FOR_SPLIT_KILL_EVENT), 'third fetch retry due to SPLIT_KILL event');
    (0, _setTimeout2.default)(function () {
  ...
  fetchMock.get(new RegExp("".concat(settings.url('/segmentChanges'), "/(employees|developers)")), function (url) {
