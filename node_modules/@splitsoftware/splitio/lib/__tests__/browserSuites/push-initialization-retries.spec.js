...
function testAuthRetries(fetchMock, assert) {
  ...
  fetchMock.get({
    url: settings.url('/mySegments/nicolas@split.io'),
    repeat: 4
  }, {
    status: 200,
