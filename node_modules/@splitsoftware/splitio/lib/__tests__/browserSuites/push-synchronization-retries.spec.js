...
var MILLIS_SECOND_RETRY_FOR_MYSEGMENT_UPDATE_EVENT = 800;
...
function testSynchronizationRetries(fetchMock, assert) {
  ...
  (0, _eventSourceMock.setMockListener)(function (eventSourceInstance) {
    ...
    (0, _setTimeout2.default)(function () {
      ...
      client.once(client.Event.SDK_UPDATE, function () {
        var lapse = (0, _now.default)() - start;
        assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_SECOND_RETRY_FOR_MYSEGMENT_UPDATE_EVENT), 'SDK_UPDATE due to MY_SEGMENTS_UPDATE event');
  ...
  fetchMock.getOnce(settings.url('/mySegments/nicolas@split.io'), function () {
    var lapse = (0, _now.default)() - start;
    assert.true((0, _utils.nearlyEqual)(lapse, MILLIS_SECOND_RETRY_FOR_MYSEGMENT_UPDATE_EVENT), 'sync second retry for MY_SEGMENTS_UPDATE event');
    return {
      status: 200,
