...
function _default(startWithTT, fetchMock, assert) {
  ...
  assert.throws((0, _bind.default)(_context = factory.client).call(_context, factory, null), 'Calling factory.client() with a key parameter that is not a valid key should throw.');
  assert.throws((0, _bind.default)(_context2 = factory.client).call(_context2, factory, {}), 'Calling factory.client() with a key parameter that is not a valid key should throw.');
  assert.throws((0, _bind.default)(_context3 = factory.client).call(_context3, factory, 'validKey', null), 'Calling factory.client() with a traffic type parameter that is not a valid should throw.');
  assert.throws((0, _bind.default)(_context4 = factory.client).call(_context4, factory, 'validKey', []), 'Calling factory.client() with a traffic type parameter that is not a valid should throw.'); // Used for wrapping up test when we should

  var finished = /*#__PURE__*/_regenerator.default.mark(function f() {
    return _regenerator.default.wrap(function f$(_context5) {
      while (1) {
