...
function _default(fetchMock, assert) {
  ...
  assert.test(function (t) {
    ...
    fetchMock.postOnce(settings.url('/events/bulk'), function (url, opts) {
      ...
      t.equal((0, _filter.default)(resp).call(resp, function (event) {
  ...
  assert.test(function (t) {
    ...
    fetchMock.postOnce(settings.url('/events/bulk'), function (url, opts) {
      ...
      (0, _setTimeout2.default)(function () {
        client.destroy().then(function () {
          (0, _forEach.default)(hitsAfterDestroyed).call(hitsAfterDestroyed, function (hit) {
    ...
    client.ready().then(function () {
      ...
      (0, _gaTestUtils.gaSpy)();
      window.ga('require', 'splitTracker');
      (0, _forEach.default)(hits).call(hits, function (hit) {
        return window.ga('send', hit);
      });
    });
  }); // test `hits` flag
