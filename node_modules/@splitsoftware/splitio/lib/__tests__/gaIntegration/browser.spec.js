...
(0, _tapeCatch.default)('## E2E CI Tests ##', function (assert) {
  ...
  assert.test('E2E / GA-to-Split', (0, _bind.default)(_gaToSplit.default).call(_gaToSplit.default, null, _fetchMock.default));
  assert.test('E2E / Split-to-GA', (0, _bind.default)(_splitToGa.default).call(_splitToGa.default, null, _fetchMock.default));
  assert.test('E2E / Both GA integrations', (0, _bind.default)(_bothIntegrations.default).call(_bothIntegrations.default, null, _fetchMock.default));
  assert.end();
});