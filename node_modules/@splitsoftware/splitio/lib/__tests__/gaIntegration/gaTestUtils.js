...
function gaSpy() {
  ...
  var fieldNames = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (0, _concat.default)(_context = []).call(_context, HIT_FIELDS, EVENT_FIELDS);
  ...
  if (typeof window[gaAlias] === 'function') {
    window[gaAlias](function () {
      ...
      try {
        (0, _forEach.default)(trackerNames).call(trackerNames, function (trackerName) {
          ...
          trackerToSniff.set('sendHitTask', function (model) {
            ...
            var hit = {};
            (0, _forEach.default)(fieldNames).call(fieldNames, function (fieldName) {
