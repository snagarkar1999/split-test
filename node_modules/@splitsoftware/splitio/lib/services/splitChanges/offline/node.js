...
function configFilesPath() {
  ...
  if (!((0, _endsWithInstanceProperty(_lang))(configFilePath, '.yaml', true) || (0, _endsWithInstanceProperty(_lang))(configFilePath, '.yml', true) || (0, _endsWithInstanceProperty(_lang))(configFilePath, '.split', true))) throw "Invalid extension specified for Splits mock file. Accepted extensions are \".yml\" and \".yaml\". Your specified file is ".concat(configFilePath);
...
function readSplitConfigFile(filePath) {
  ...
  previousMock = data;
  var splitObjects = (0, _reduce.default)(_context = data.split(/\r?\n/)).call(_context, function (accum, line, index) {
    var tuple = (0, _trim.default)(line).call(line);
...
function readYAMLConfigFile(filePath) {
  ...
  var mocksData = (0, _reduce.default)(yamldoc).call(yamldoc, function (accum, splitEntry) {
    var splitName = (0, _keys.default)(splitEntry)[0];
...
function arrangeConditions(mocksData) {
  ...
  (0, _lang.forOwn)(mocksData, function (data) {
    ...
    var firstRolloutCondition = (0, _findInstanceProperty(_lang))(conditions, function (cond) {
    ...
    (0, _forEach.default)(treatments).call(treatments, function (treatment) {
...
function getSplitConfigForFile(settings) {
  ...
  if ((0, _endsWithInstanceProperty(_lang))(filePath, '.split')) {
