        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            fetchMock.postOnce(settings.url('/testImpressions/bulk'), function (url, opts) {
              ...
              impressions[0].keyImpressions = map(impressions[0].keyImpressions, function (imp) {
                return pick(imp, ['keyName', 'treatment']);
              });
          ...
          case 10:
            ...
            assert["true"](destroyPromise instanceof _Promise, 'client.destroy() should return a promise.');
            _context.next = 17;
