...
import splitChangesMock1 from '../mocks/splitchanges.since.-1.json'; // Header keys and expected values. Expected values are obtained with the runtime function evaluated with IPAddressesEnabled in true.
...
export default function (fetchMock, assert) {
  ...
  function mockAndAssertIPAddressesEnabled(config) {
    ...
    fetchMock.getOnce(settings.url("/mySegments/".concat(config.core.key)), {
      status: 200,
      body: {
        mySegments: []
      }
