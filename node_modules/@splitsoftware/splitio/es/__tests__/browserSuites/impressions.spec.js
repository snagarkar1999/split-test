...
export default function (fetchMock, assert) {
  ...
  var assertPayload = function assertPayload(req) {
    ...
    var dependencyChildImpr = _filterInstanceProperty(resp).call(resp, function (e) {
      return e.testName === 'hierarchical_splits_test';
    })[0];

    var alwaysOnWithConfigImpr = _filterInstanceProperty(resp).call(resp, function (e) {
    ...
    assert["false"](_someInstanceProperty(resp).call(resp, function (e) {
