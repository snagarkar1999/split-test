...
export function testFallbacking(fetchMock, assert) {
  ...
  setMockListener(function (eventSourceInstance) {
    ...
    var expectedSSEurl = _concatInstanceProperty(_context = "".concat(settings.url('/sse'), "?channels=NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_NTcwOTc3MDQx_mySegments,NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_splits,%5B%3Foccupancy%3Dmetrics.publishers%5Dcontrol_pri,%5B%3Foccupancy%3Dmetrics.publishers%5Dcontrol_sec&accessToken=")).call(_context, authPushEnabledNicolas.token, "&v=1.1&heartbeats=true");
    ...
    _setTimeout(function () {
      ...
      setMockListener(function (eventSourceInstance) {
        ...
        var expectedSSEurl = _concatInstanceProperty(_context2 = "".concat(settings.url('/sse'), "?channels=NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_MjE0MTkxOTU2Mg%3D%3D_mySegments,NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_NTcwOTc3MDQx_mySegments,NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_splits,%5B%3Foccupancy%3Dmetrics.publishers%5Dcontrol_pri,%5B%3Foccupancy%3Dmetrics.publishers%5Dcontrol_sec&accessToken=")).call(_context2, authPushEnabledNicolasAndMarcio.token, "&v=1.1&heartbeats=true");
  ...
  fetchMock.getOnce(settings.url(_concatInstanceProperty(_context3 = "/auth?users=".concat(encodeURIComponent(userKey), "&users=")).call(_context3, encodeURIComponent(secondUserKey))), function (url, opts) {
    if (!opts.headers['Authorization']) assert.fail('`/auth` request must include `Authorization` header');
  ...
  fetchMock.getOnce(settings.url(_concatInstanceProperty(_context4 = _concatInstanceProperty(_context5 = "/auth?users=".concat(encodeURIComponent(userKey), "&users=")).call(_context5, encodeURIComponent(secondUserKey), "&users=")).call(_context4, encodeURIComponent(thirdUserKey))), {
