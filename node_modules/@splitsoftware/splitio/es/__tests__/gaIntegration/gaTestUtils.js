...
export function gaSpy() {
  ...
  var fieldNames = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _concatInstanceProperty(_context = []).call(_context, HIT_FIELDS, EVENT_FIELDS);
  ...
  if (typeof window[gaAlias] === 'function') {
    window[gaAlias](function () {
      ...
      try {
        _forEachInstanceProperty(trackerNames).call(trackerNames, function (trackerName) {
          ...
          trackerToSniff.set('sendHitTask', function (model) {
            ...
            _forEachInstanceProperty(fieldNames).call(fieldNames, function (fieldName) {
