...
export default function (fetchMock, assert) {
  ...
  assert.test(function (t) {
    ...
    fetchMock.postOnce(settings.url('/events/bulk'), function (url, opts) {
      ...
      t.equal(_filterInstanceProperty(resp).call(resp, function (event) {
  ...
  assert.test(function (t) {
    ...
    fetchMock.postOnce(settings.url('/events/bulk'), function (url, opts) {
      ...
      _setTimeout(function () {
        client.destroy().then(function () {
          _forEachInstanceProperty(hitsAfterDestroyed).call(hitsAfterDestroyed, function (hit) {
    ...
    client.ready().then(function () {
      ...
      _forEachInstanceProperty(hits).call(hits, function (hit) {
        return window.ga('send', hit);
      });
    });
  }); // test `hits` flag
