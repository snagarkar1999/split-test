...
function ClientFactory(context) {
  ...
  function getTreatments(key, splitNames, attributes) {
    ...
    var wrapUp = function wrapUp(evaluationResults) {
      ...
      _forEachInstanceProperty(_context = _Object$keys(evaluationResults)).call(_context, function (splitName) {
  ...
  function processEvaluation(evaluation, splitName, key, attributes) {
    ...
    log.info(_concatInstanceProperty(_context2 = _concatInstanceProperty(_context3 = _concatInstanceProperty(_context4 = "Split: ".concat(splitName, ". Key: ")).call(_context4, matchingKey, ". Evaluation: ")).call(_context3, treatment, ". Label: ")).call(_context2, label));
