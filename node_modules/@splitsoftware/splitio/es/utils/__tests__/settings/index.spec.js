...
tape('SETTINGS / urls should be correctly assigned', function (assert) {
  ...
  _forEachInstanceProperty(_context = ['/mySegments/nico', '/mySegments/events@split', '/mySegments/metrics@split', '/mySegments/testImpressions@split', '/mySegments/testImpressions', '/mySegments/events', '/mySegments/metrics', '/splitChanges?since=-1', '/splitChanges?since=100', '/segmentChanges/segment1?since=100', '/segmentChanges/events?since=100', '/segmentChanges/beacon?since=100', '/segmentChanges/metrics?since=100', '/segmentChanges/testImpressions?since=100']).call(_context, function (relativeUrl) {
    var _context2, _context3;

    assert.equal(settings.url(relativeUrl), _concatInstanceProperty(_context2 = "".concat(baseSdkUrl)).call(_context2, relativeUrl), _concatInstanceProperty(_context3 = "Our settings URL function should use ".concat(baseSdkUrl, " as base for ")).call(_context3, relativeUrl));
  });

  _forEachInstanceProperty(_context4 = ['/metrics/times', '/metrics/counters', '/events/bulk', '/events/beacon', '/testImpressions/bulk', '/testImpressions/beacon']).call(_context4, function (relativeUrl) {
    var _context5, _context6;

    assert.equal(settings.url(relativeUrl), _concatInstanceProperty(_context5 = "".concat(baseEventsUrl)).call(_context5, relativeUrl), _concatInstanceProperty(_context6 = "Our settings URL function should use ".concat(baseEventsUrl, " as base for ")).call(_context6, relativeUrl));
  });
