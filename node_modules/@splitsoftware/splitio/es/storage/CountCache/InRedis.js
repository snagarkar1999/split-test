...
var CountCacheInRedis = /*#__PURE__*/function (_BaseMetricsAsyncCach) {
  ...
  function CountCacheInRedis(keys, redis) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CountCacheInRedis).call(this));
    _this.keys = keys;
    _this.redis = redis;
    return _this;
  }
  ...
  _createClass(CountCacheInRedis, [{
    ...
    value: function track(metricName) {
      return this.redis.incr(_keysInstanceProperty(this).buildCountKey(metricName))["catch"](function () {// noop, for telemetry metrics there's no need to throw.
      });
    }
  }]);
