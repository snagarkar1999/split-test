...
var LatencyCacheInRedis = /*#__PURE__*/function (_BaseMetricsAsyncCach) {
  ...
  function LatencyCacheInRedis(keys, redis) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(LatencyCacheInRedis).call(this));
    _this.keys = keys;
    _this.redis = redis;
    return _this;
  }
  ...
  _createClass(LatencyCacheInRedis, [{
    ...
    value: function track(metricName, latency) {
      ...
      return this.redis.incr(_keysInstanceProperty(this).buildLatencyKey(metricName, bucketNumber))["catch"](function () {// noop, for telemetry metrics there's no need to throw.
      });
    }
  }]);
